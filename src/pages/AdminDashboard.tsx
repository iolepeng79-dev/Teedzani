              ...
              {registrations.map((reg) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="font-bold text-gray-800">{reg.business_name}</h3>
                  ...
                  >
                    ...
                    <div className="space-y-6 mb-8">
                      <div>
                        ...
                        <p className="font-bold text-gray-800">{selectedReg.business_name}</p>
                      </div>
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-1">Owner</p>
                          <p className="text-sm text-gray-700">{selectedReg.full_name}</p>
                        </div>
                        <div>
                          <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-1">Package</p>
                          <p className="text-sm text-gray-700">{selectedReg.package_name}</p>
                        </div>
                      </div>
                      <div>
