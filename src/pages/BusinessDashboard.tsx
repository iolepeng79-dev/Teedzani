...
export default function BusinessDashboard() {
  ...
  useEffect(() => {
    if (user?.id) {
      fetch(`/api/business/stats/${user.id}`)
        .then(res => res.json())
        .then(data => {
          setStats(data);
          setLoading(false);
            ...
            <div className="space-y-6">
              <div>
                <div className="flex justify-between text-sm mb-2">
                  ...
                  <span className="font-bold">12 / {user.package_name === 'Premium' ? '50' : user.package_name === 'Standard' ? '25' : '1'}</span>
                </div>
                <div className="w-full h-2 bg-gray-100 rounded-full overflow-hidden">
              ...
              <div>
                <div className="flex justify-between text-sm mb-2">
                  ...
                  <span className="font-bold">2 / {user.package_name === 'Premium' ? '5' : user.package_name === 'Standard' ? '2' : '0'}</span>
                </div>
                <div className="w-full h-2 bg-gray-100 rounded-full overflow-hidden">
